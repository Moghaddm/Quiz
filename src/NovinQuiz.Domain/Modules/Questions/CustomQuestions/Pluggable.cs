...
namespace NovinQuiz.Modules.Questions.CustomQuestions
{
    ...
    {
        public List<PluggableQuestionAnswerItem> Items { get; private set; } = CustomQuestionManagerService.CheckPluggableItemsValid(items);
        public void SetItems(List<PluggableQuestionAnswerItem> items) => CustomQuestionManagerService.CheckPluggableItemsValid(items);
    }
}
