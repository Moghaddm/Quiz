...
namespace NovinQuiz.Modules.Questions.CustomQuestions.Services
{
    ...
    {
        public static List<BlankAnswerSection> CheckBlankAnswerSectionsValid(List<BlankAnswerSection> answers, CustomQuestionText text)
        {
        ...
        public static List<MultipleChoiceChanceItem> CheckMultipleChoiceChancesItemsValid(List<MultipleChoiceChanceItem> items, float score)
        {
        ...
        public static List<PluggableItem> CheckPluggableItemsValid(List<PluggableItem> items)
        {
