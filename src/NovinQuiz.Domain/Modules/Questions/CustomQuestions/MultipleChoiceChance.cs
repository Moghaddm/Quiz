...
namespace NovinQuiz.Modules.Questions.CustomQuestions
{
    ...
    {
        public List<MultipleChoiceChanceItem> Choices { get; private set; } = CustomQuestionManagerService.CheckMultipleChoiceChancesAnswersValid(items, score);
        public void SetChoices(List<MultipleChoiceChanceItem> items) => Choices = CustomQuestionManagerService.CheckMultipleChoiceChancesAnswersValid(items, score);
    }
}
